...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/wild-resonance-6a8e)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wild-resonance-6a8e
```

A live public deployment of this template is available at [https://wild-resonance-6a8e.templates.workers.dev](https://wild-resonance-6a8e.templates.workers.dev)
